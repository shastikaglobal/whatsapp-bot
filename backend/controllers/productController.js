...
export const createProduct = async (req, res) => {
  ...
  try {
    await pool.query(
      'INSERT INTO products (id, name, category, description, price, moq, availability, shippingInfo) VALUES (?, ?, ?, ?, ?, ?, ?, ?)',
...
export const updateProduct = async (req, res) => {
  ...
  try {
    await pool.query(
      'UPDATE products SET name = ?, category = ?, description = ?, price = ?, moq = ?, availability = ?, shippingInfo = ? WHERE id = ?',
